...
import com.android.identity.jvm.util.AndroidAttestationExtensionParser
...
class AndroidKeystoreSecureAreaDocumentStoreTest {
    ...
    fun testBasic() {
        ...
        val cert = attestation.certChain!!.certificates[0] as X509Certificate

// Use the certificate in AndroidAttestationExtensionParser
        AndroidAttestationExtensionParser(cert)
        val parser =
            AndroidAttestationExtensionParser(cert)
