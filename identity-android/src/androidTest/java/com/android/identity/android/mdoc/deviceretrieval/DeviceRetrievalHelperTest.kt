...
import com.android.identity.jvm.crypto.Crypto.createEcPrivateKey
import com.android.identity.jvm.crypto.X509Cert
import com.android.identity.jvm.crypto.create
...
class DeviceRetrievalHelperTest {
    ...
    fun setUp() {
        ...
        val unprotectedHeaders = X509CertChain(listOf(documentSignerCert)).toDataItem()?.let {
