...
interface DocumentManager {
    ...
    fun storeIssuedSDJWTDocument(unsignedDocument: UnsignedDocument, sdJwt: SdJwtVerifiableCredential): StoreDocumentResult
    ...
    class Builder(context: Context) {
        ...
        private val storageEngine: StorageEngine
            get() = AndroidStorageEngine.Builder(_context, Path(storageDir.path))
