...
object Crypto {
     ...
     */
    val supportedCurves: Set<EcCurve>? = null
     ...
     */
    fun createEcPrivateKey(curve: EcCurve): EcPrivateKey? = null
    ...
    fun hpkeEncrypt(
        ...
        plainText: ByteArray,
        aad: ByteArray
    ): Pair<ByteArray, EcPublicKey>? = null
    ...
    internal fun ecPublicKeyToPem(publicKey: EcPublicKey): String? = null

    internal fun ecPublicKeyFromPem(pemEncoding: String, curve: EcCurve): EcPublicKey? = null

    internal fun ecPrivateKeyToPem(privateKey: EcPrivateKey): String? = null

    internal fun ecPrivateKeyFromPem(pemEncoding: String, publicKey: EcPublicKey): EcPrivateKey? = null

    internal fun uuidGetRandom(): UUID? = null
}